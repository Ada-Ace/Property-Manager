 ...
 *    - TENANTS (Headers: ID, NAME, UNIT, MOBILE, PASSWORD, BASERENT, DEPOSIT, LEASESTART, LEASEEND, LEASEDOCUMENT, LEASEEXTENSIONDOC, PROPERTYNAME, LASTUPDATED)
 ...
 *    - MESSAGES (Headers: ID, TENANTID, CONTENT, TIMESTAMP, PHOTOURL, PROPERTYNAME, STATUS, RESPONSE, RESOLVEDAT, HANDLEDBY)
